...
from ..models.character.schemas import CharacterModel, CharacterSearchResponseModel, Search, SearchDetail
...
@router.get("/search", status_code=status.HTTP_200_OK, response_model=CharacterSearchResponseModel)
